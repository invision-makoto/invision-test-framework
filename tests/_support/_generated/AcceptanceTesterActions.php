<?php  //[STAMP] 264ab7fc01b438dea5355b6609526436
...
trait AcceptanceTesterActions
{
     ...
     * @see \Codeception\Module\PhpBrowser::executeInGuzzle()
     */
    public function tryToExecuteInGuzzle($function) {
     ...
     * @see \Codeception\Module\PhpBrowser::executeInGuzzle()
     */
    public function retryExecuteInGuzzle($function) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxGetRequest()
     */
    public function tryToSendAjaxGetRequest($uri, $params = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxGetRequest()
     */
    public function retrySendAjaxGetRequest($uri, $params = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxPostRequest()
     */
    public function tryToSendAjaxPostRequest($uri, $params = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxPostRequest()
     */
    public function retrySendAjaxPostRequest($uri, $params = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxRequest()
     */
    public function tryToSendAjaxRequest($method, $uri, $params = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::sendAjaxRequest()
     */
    public function retrySendAjaxRequest($method, $uri, $params = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::setCookie()
     */
    public function tryToSetCookie($name, $val, $params = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::setCookie()
     */
    public function retrySetCookie($name, $val, $params = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::resetCookie()
     */
    public function tryToResetCookie($name, $params = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::resetCookie()
     */
    public function retryResetCookie($name, $params = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::moveBack()
     */
    public function tryToMoveBack($numberOfSteps = null) {
     ...
     * @see \Codeception\Lib\InnerBrowser::moveBack()
     */
    public function retryMoveBack($numberOfSteps = null) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
     ...
     * @see \Codeception\Lib\InnerBrowser::setServerParameters()
     */
    public function tryToSetServerParameters($params) {
     ...
     * @see \Codeception\Lib\InnerBrowser::setServerParameters()
     */
    public function retrySetServerParameters($params) {
        $retryNum = isset($this->retryNum) ? $this->retryNum : 1;
        $retryInterval = isset($this->retryInterval) ? $this->retryInterval : 200;
